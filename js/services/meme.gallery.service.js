...
var gMemesImgs = [
    ...
    { id: 6, url: 'assets/img/6.jpg', keywords: ['history', 'ancient', 'aliens', 'professor', 'explain', 'it is like that', 'it\'s like that', 'זה ככה', 'זה ממש ככה', 'הסבר'], size: 's' },
    { id: 7, url: 'assets/img/7.jpg', keywords: ['funny', 'baby', 'shock', 'see', 'happy', 'realize', 'מצחיק', 'תינוק', 'שוק', 'שמע', 'הלם', 'בהלם'], size: 'xs' },
    { id: 8, url: 'assets/img/8.jpg', keywords: ['funny', 'hat', 'hear', 'listen', 'talk', 'too much', 'מצחיק', 'מקשיב', 'חופר', 'מדבר יותר מידי'], size: 'm' },
    ...
    { id: 18, url: 'assets/img/18.jpg', keywords: ['everywhere', 'everything will be yours', 'funny', 'כל זה שלך', 'מצחיק'], size: 'xs' },
    { id: 19, url: 'assets/img/19.jpg', keywords: ['alone', 'fine', 'but', 'not', 'dance', 'לבד', 'כיף', 'ריקוד'], size: 'xxs' },
    { id: 20, url: 'assets/img/20.jpg', keywords: ['oprah', 'you have got', 'you\'ve got', 'אופרה', 'קיבלת', 'קיבלתם'], size: 'xxs' },
    { id: 21, url: 'assets/img/21.jpg', keywords: ['no', 'what are you doing', 'shock', 'לא', 'מה עשית', 'מה אתה עושה', 'הלם', 'בהלם'], size: 's' },
    { id: 22, url: 'assets/img/22.jpg', keywords: ['drevil', 'funny', 'sure', 'sarcasm', 'מצחיק', 'ציני', 'סרקזם', 'כן בטח', 'ברור'], size: 'xxs' },
    { id: 23, url: 'assets/img/23.jpg', keywords: ['funny', 'dancing', 'happy', 'מצחיק', 'כיף', 'שמח', 'שמחים', 'רוקדים', 'ריקוד'], size: 's' },
